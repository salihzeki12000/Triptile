...
/**
 * Source plugin for the FirstPaymentsTransaction.
 *
 * @MigrateSource(
 *   id = "first_payments_transaction"
 * )
 */
class FirstPaymentsTransaction extends SqlBase {
  ...
  public function query() {
    ...
    $parentCondition = $query->orConditionGroup()
      ->condition('ypft.parent_transaction_id', '')
      ->isNull('ypft.parent_transaction_id');
...
//      ->condition('ypt.updated_at', '2017-07-10 04:10:20', '>');
    $query->fields('ypft', ['id', 'payment_transaction_id', 'created_at', 'updated_at']);
