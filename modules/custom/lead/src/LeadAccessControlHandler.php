...
/**
 * Access controller for the Lead entity.
 *
 * @see \Drupal\lead\Entity\Lead.
 */
class LeadAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\lead\Entity\LeadInterface $entity */
    switch ($operation) {
      case 'view':
        return AccessResult::allowedIfHasPermission($account, 'view lead entities');
